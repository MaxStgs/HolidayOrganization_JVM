...
public class StatementsApiController implements StatementsApi {
    ...
    public ResponseEntity<ListOfStatements> statementsGet() {
        String accept = request.getHeader("Accept");
        return new ResponseEntity<ListOfStatements>(HttpStatus.NOT_IMPLEMENTED);
    }

    public ResponseEntity<Void> statementsPost(@ApiParam(value = ""  )  @Valid @RequestBody PostStatementDetails body) {
        String accept = request.getHeader("Accept");
